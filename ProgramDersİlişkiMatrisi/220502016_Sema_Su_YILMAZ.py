...
def save_table4_to_database():
    ...
    # Değerlendirme ağırlıklarını al
    cursor.execute("SELECT Criteria, Weight FROM EvaluationCriteria;")
    evaluation_weights = {row[0]: row[1] for row in cursor.fetchall()}
    ...
    # Table4 tablosunun var olup olmadığını kontrol et ve varsa sil
    ...
    # Öğrenci verilerini ve ders çıktıları verilerini kullanarak veri ekle
    for student in student_data:
...
def create_table5():
    ...
    for student in students:
        ...
        # Her öğrenci için yeni bir sayfa
        ...
        # ProgramOutcomes başlıkları ve başarı oranları
        ...
        # ProgramOutcomes ID'leri ve başarı oranlarıyla hesaplanan değerler
        for program_outcome in program_outcomes:
            ...
            # Başarı oranları ve ilişki değerleri
            row_values = [
